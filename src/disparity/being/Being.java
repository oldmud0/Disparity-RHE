...
import disparity.races.*;
import disparity.skills.defensiveSkills.*;
import disparity.skills.offensiveSkills.*;
...
public abstract class Being{
	...
	public double calcAC(){
		double armorAC = boots.base_def + legs.base_def + chest.base_def + helm.base_def;
		double skillBonus = this.getDefenseBonus();
		return (armorAC + skillBonus) / 50;
	}
	
	public double getDefenseBonus(){
		return boots.getSADB(this).defBonus + 
				legs.getSADB(this).defBonus + 
				chest.getSADB(this).defBonus + 
				helm.getSADB(this).defBonus;
	}
